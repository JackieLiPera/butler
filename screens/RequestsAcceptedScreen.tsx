...
type RequestsAcceptedRouteProp = RouteProp<
  RootStackParamList,
  "RequestsAccepted"
>;
...
export default function RequestsAcceptedScreen() {
  const route = useRoute<RequestsAcceptedRouteProp>();
  ...
  return (
    <View style={styles.container}>
      {requests.length ? (
        ...
        <Text style={styles.empty}>No accepted requests found.</Text>
      )}
      <BottomNav user={user} />
    </View>
  );
